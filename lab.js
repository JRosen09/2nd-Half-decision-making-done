...
/*
  ...
  if Amy or Brittani is older, and then console.log '{name} is older'. 
...
if(temperature > 80 && rain === true){
  ...
  console.log(`Its a Zippidydodah day`)
}else{
  console.log(`Might need a jacket only`)
}
...
/*
  ...
  runs 10 times, 
  and on each iteration logs the word 'hello'.
*/
...
/*
  ...
  logs "Your score is not high enough" 
...
// change the current value of changeMyMind to true 
// (it should currently be set to false due to the if-else statement in Problem 9). 
//After you change the value of changeMyMind, 
...
//log a countdown from the value of z to 1. 
